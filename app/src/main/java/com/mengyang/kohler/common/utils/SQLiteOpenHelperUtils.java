...
public class SQLiteOpenHelperUtils extends SQLiteOpenHelper {
    ...
    public SQLiteOpenHelperUtils(Context context, String name, SQLiteDatabase.CursorFactory factory,
                                 int version) {
    ...
    public SQLiteOpenHelperUtils(Context context, String name, int version) {
        this(context, name, null, version);
    }


    public SQLiteOpenHelperUtils(Context context, String name) {
