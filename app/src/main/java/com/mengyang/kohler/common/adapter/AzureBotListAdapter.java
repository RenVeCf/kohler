 ...
 */
public class AzureBotListAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    private Context context;
    private List<DataBean> dataBeanList;
    private LayoutInflater mInflater;
    private OnScrollListener mOnScrollListener;

    public AzureBotListAdapter(Context context, List<DataBean> dataBeanList) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case DataBean.PARENT_ITEM:
                view = mInflater.inflate(R.layout.azure_bot_list_item_parent, parent, false);
                return new AzureBotListParentViewHolder(context, view);
            case DataBean.CHILD_ITEM:
                view = mInflater.inflate(R.layout.azure_bot_list_item_child, parent, false);
                return new AzureBotListChildViewHolder(context, view);
            default:
                view = mInflater.inflate(R.layout.azure_bot_list_item_parent, parent, false);
                return new AzureBotListParentViewHolder(context, view);
        }
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            case DataBean.PARENT_ITEM:
                AzureBotListParentViewHolder parentViewHolder = (AzureBotListParentViewHolder) holder;
                parentViewHolder.bindView(dataBeanList.get(position), position, itemClickListener);
                break;
            case DataBean.CHILD_ITEM:
                AzureBotListChildViewHolder childViewHolder = (AzureBotListChildViewHolder) holder;
