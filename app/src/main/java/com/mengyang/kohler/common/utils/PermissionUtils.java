...
public class PermissionUtils {
    ...
    public static void requestPermission(final Activity activity, final int requestCode, PermissionGrant permissionGrant) {
        ...
        try {
            ...
            ToastUtil.showToast(activity.getResources().getText(R.string.Toast_permission) + "");
            return;
        }
    ...
    public static void requestPermissionsResult(final Activity activity, final int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults, PermissionGrant permissionGrant) {
        ...
        if (requestCode < 0 || requestCode >= requestPermissions.length) {
            ...
            ToastUtil.showToast(activity.getResources().getText(R.string.permission_illegal_code) + "" + requestCode);
            return;
        }
