...
//                    helper.getView(R.id.view_home_parent_line).setVisibility(View.VISIBLE);
//                if (mPositionLineVisible)
//                    helper.getView(R.id.view_home_parent_line).setVisibility(View.GONE);
//                if (helper.getView(R.id.view_home_parent_line).getVisibility() == View.VISIBLE) {
